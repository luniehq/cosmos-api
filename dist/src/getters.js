...
export default function Getters(cosmosRESTURL) {
    // request and retry
    function get(path, options, tries) {
        if (options === void 0) { options = { page: 1, limit: 30, all: false }; }
        if (tries === void 0) { tries = RETRIES; }
        return __awaiter(this, void 0, void 0, function () {
            var response, url, isTxsPagination, _a, _b, err_1;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        if (isTxsPagination)
                            url = url + ("&page=" + options.page + "&limit=" + options.limit);
                    ...
                    case 2:
                        ...
                        if (!options.all || Number(response.page_number) >= Number(response.page_total))
                            return [2 /*return*/, response.txs];
                        options.page = options.page + 1;
                        _b = (_a = response.txs).concat;
                        return [4 /*yield*/, get(path, options)];
                    ...
                    case 7: return [2 /*return*/, response.result];
                }
            });
        });
    }
    return {
        ...
        txs: function (addr, pageOpts) {
            return get("/txs?message.sender=" + addr, pageOpts);
        },
        bankTxs: function (addr, pageOpts) {
            return Promise.all([
        ...
        txsByHeight: function (height, pageOpts) {
        ...
        undelegations: function (addr) {
            return get("/staking/delegators/" + addr + "/unbonding_delegations");
        },
