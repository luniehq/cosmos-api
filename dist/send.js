...
export default function send(_a, messages, signer, cosmosRESTURL, chainId, accountNumber, sequence) {
    var gas = _a.gas, _b = _a.gasPrices, gasPrices = _b === void 0 ? DEFAULT_GAS_PRICE : _b, _c = _a.memo, memo = _c === void 0 ? "" : _c;
    return __awaiter(this, void 0, void 0, function () {
        var signedTx, body, res;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0: return [4 /*yield*/, createSignedTransaction({ gas: gas, gasPrices: gasPrices, memo: memo }, messages, signer, chainId, accountNumber, sequence)
...
export function createSignedTransaction(_a, messages, signer, chainId, accountNumber, sequence) {
    var gas = _a.gas, _b = _a.gasPrices, gasPrices = _b === void 0 ? DEFAULT_GAS_PRICE : _b, _c = _a.memo, memo = _c === void 0 ? "" : _c;
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    stdTx = createStdTx({ gas: gas, gasPrices: gasPrices, memo: memo }, messages);
                ...
                case 2:
                    (_d = _e.sent(), signature = _d.signature, publicKey = _d.publicKey);
                    return [3 /*break*/, 4];
                case 3:
                    err_1 = _e.sent();
...
export function createStdTx(_a, messages) {
    var gas = _a.gas, gasPrices = _a.gasPrices, memo = _a.memo;
    var fees = gasPrices.map(function (_a) {
        var amount = _a.amount, denom = _a.denom;
        return ({ amount: String(Math.round(amount * gas)), denom: denom });
    })
        .filter(function (_a) {
